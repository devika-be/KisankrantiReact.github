                      ...
                      <div className="card-body">
                        ...
                        <div className="input-group">
                          ...
                          <label htmlFor="contactform-upload">
                            Upload Photos of selling Product :
                          </label>
                          <br />
                          <input
                        ...
                        <div className="input-group">
                          ...
                          <label htmlFor="contactform-upload">
                            Upload Video of selling Product :
                          </label>
                          <br />
                          <input
                            id="contactform-upload"
                        ...
                        <div className="input-group">
                          ...
                          <label htmlFor="contactform-upload">Quantity :</label>
                          <br />
                              ...
                              <div id="checkRadios4">
                                ...
                                <div className="input-group">
                                  ...
                                  <input
                                    type="text"
                                    className="form-control"
                                    placeholder="Enter Quantity To Sell in 500kg"
                                  />
                                </div>
                                <div className="input-group">
                                  <div className="input-group-prepend">
